      ...
      <div class="col-xl-4 col-md-4 mb-4">
             ...
             <div class="text-xs font-weight-bold text-success text-uppercase mb-1">TOTAL  NUMBER  OF  PATIENT  RECORDS</div>
                    ...
                    <div class="col mr-2">
                      ...
                      <?php echo "&nbsp&nbsp&nbsp&nbsp&nbsp <a class='text-secondary' href='". base_url()."admissioncontrol/admitdatatable'>"."<div>".$get_data."</div>"."</a>" ?>
              ...
              <div class="card border-left-success shadow h-100 py-2">
               ...
               <div class="text-xs font-weight-bold text-success text-uppercase mb-1">NUMBER OF USER ACCOUNTS</div>
                      ...
                      <div class="h3 mb-0 font-weight-bold text-gray-800">
                       ...
                       <?php echo "&nbsp&nbsp&nbsp&nbsp&nbsp <a class='text-secondary' href='". base_url()."addusercontrol/adduserview'>"."<div>".$get_user."</div>"."</a>" ?>
              ...
              <div class="card border-left-success shadow h-100 py-2">
               ...
               <div class="text-xs font-weight-bold text-success text-uppercase mb-1">NUMBER OF DOCTORS REGISTERED</div>
                      ...
                      <div class="h3 mb-0 font-weight-bold text-gray-800">
                       ...
                       <?php echo "&nbsp&nbsp&nbsp&nbsp&nbsp <a class='text-secondary' href='". base_url()."addusercontrol/adddoctorview'>"."<div>".$get_doctor."</div>"."</a>" ?>
