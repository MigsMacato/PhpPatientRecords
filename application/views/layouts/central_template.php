 ...
 <?php echo "<div class='alert-success text-center'>".$this->session->flashdata('sec_pass')."</div>"  ?>
  ...
  <div id="wrapper">
    ...
    <ul class=" navbar-nav bg-gradient-success sidenav sidebar sidebar-dark accordion " id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center"  href="admissioncontrol/admitdatatable">
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Patient Record Management System</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
