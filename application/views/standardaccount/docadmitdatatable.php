           ...
           <?php endif; ?>
              ...
              <div class="table1">
                ...
                <?//php echo "<td class='text-center'>". $patient->pr_date ."</td>" ?>
                 ...
                 <!--REMOVE IN DOC PAGE--> <?php echo "<td class='text-center'><a style='margin-left:5px;' class='btn btn-info' href='". base_url() ."standardusercontrol/patientdataview/". $patient->pr_id ."'>View
                  </a></td>" ?>
