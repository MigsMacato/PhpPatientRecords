   ...
   <div class="row">             
    ...
    <div class="col-sm-6">
       ...
       <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">Vital Signs</div>
          ...
          <input class="form-control<?= (form_error('a_bp') == "" ? '':'is-invalid') ?>" type="text" name="a_bp" value="<?php echo set_value('a_bp'); ?>" placeholder="BP">            
          <div class="text-danger"><?php echo form_error('a_bp'); ?></div>   
        </div>
           
           <div class="col-sm-4">
          <?php echo form_label('Respiratory Rate'); ?>
          <input class="form-control<?= (form_error('a_rr') == "" ? '':'is-invalid') ?>" type="text" name="a_rr" value="<?php echo set_value('a_rr'); ?>"  placeholder="RR">  
           </div>
           <div class="text-danger"><?php echo form_error('a_rr'); ?></div>
           <div class="col-sm-4">
             <?php echo form_label('Capillary Refill'); ?>
          <input class="form-control<?= (form_error('a_cr') == "" ? '':'is-invalid') ?>" type="text" name="a_cr" value="<?php echo set_value('a_cr'); ?>"  placeholder="CR">   
           </div>
           <div class="text-danger"><?php echo form_error('a_cr'); ?></div>
          </div><!--End First Column --><br>
           <div class="row"><!--Begin Second Column -->
          <div class="col-sm-4">
          <?php echo form_label('Temperature'); ?>
          <input class="form-control<?= (form_error('a_temp') == "" ? '':'is-invalid') ?>" type="text" name="a_temp" value="<?php echo set_value('a_temp'); ?>" placeholder="TEMP">
           </div>
           <div class="text-danger"><?php echo form_error('a_temp'); ?></div>
          <div class="col-sm-4">
              <?php echo form_label('Weight'); ?>
          <input class="form-control<?= (form_error('a_wt') == "" ? '':'is-invalid') ?>" type="text" name="a_wt" value="<?php echo set_value('a_wt'); ?>" placeholder="WT">     
           </div>
           <div class="text-danger"><?php echo form_error('a_wt'); ?></div>
          <div class="col-sm-4">
              <?php echo form_label('Pulse Rate'); ?>
          <input class="form-control<?= (form_error('a_pr') == "" ? '':'is-invalid') ?>" type="text" name="a_pr" value="<?php echo set_value('a_pr'); ?>" placeholder="PR">  
           </div>
           <div class="text-danger"><?php echo form_error('a_pr'); ?></div>
